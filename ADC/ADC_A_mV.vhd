...
entity ADC_A_mV is
	...
	PORT(
		...
		conversion_mv : out std_logic_vector(N_BITS_mV-1 downto 0)
	);
END entity;
...
architecture Behavioral of ADC_A_mV is
	...
	begin
		...
		PRODUCTO <= (unsigned(cuentas_ADC)*to_unsigned(5*1000, N_BITS_FACTOR));		-- multiplicacion por 5, el rango de tension ; multiplicamos por 1000 para representar del 0 al 5000 y luego en los displays encendemos el punto decimal en el primer digito, de manera que queda 5,000
		DIVISION <= PRODUCTO(N_BITS_PRODUCTO-1 downto 12);									-- division entre 4096 que equivale a un desplazamiento a la derecha de 12 bits (2^12=4096) o quedarse con los 13 bits (25 totales - 12 desplazados y eliminados) mas significativos
